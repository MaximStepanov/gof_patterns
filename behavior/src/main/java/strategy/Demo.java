...
import strategy.sortingstrategies.BubbleSort;
import strategy.sortingstrategies.QuickSort;
import strategy.sortingstrategies.SortStrategy;
...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the order strategy B for Bubble of Q for Quick (B/Q): ");
        try {
